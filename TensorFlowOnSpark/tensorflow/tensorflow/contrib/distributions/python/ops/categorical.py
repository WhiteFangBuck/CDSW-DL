...
class Categorical(distribution.Distribution):
  ...
  def _log_prob(self, k):
    ...
    return -nn_ops.sparse_softmax_cross_entropy_with_logits(logits=logits, labels=k)
  ...
  def _entropy(self):
    ...
    ret = array_ops.reshape(
        nn_ops.softmax_cross_entropy_with_logits(logits=logits_2d, labels=histogram_2d),
        self.batch_shape())
