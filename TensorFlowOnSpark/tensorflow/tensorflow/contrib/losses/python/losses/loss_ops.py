...
def softmax_cross_entropy(
    logits=logits, labels=onehot_labels, weights=_WEIGHT_SENTINEL, label_smoothing=0,
    scope=None, weight=_WEIGHT_SENTINEL):
...
def sparse_softmax_cross_entropy(
  ...
  with ops.name_scope(scope, "sparse_softmax_cross_entropy_loss",
    ...
    losses = nn.sparse_softmax_cross_entropy_with_logits(logits=logits, labels=labels,
                                                         name="xentropy")
    return compute_weighted_loss(losses, weights)
